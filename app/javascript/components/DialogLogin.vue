...
<div @click.capture="startPosEmail">
  <div class="login-block" @click.capture="startPosPassword" >
    <div class="block-one">
    ...
    <div class="block-two" >
      ...
      <div class="input-content" @click.stop="moveLabelforEmail" @keyup="moveLabelforEmail">
        <label class="label email">Email</label>
        <input v-model="storeAuth.email" class="input one"/> 
      </div>
      <div class="input-content" @click.stop="moveLabelforPassword" @keyup="moveLabelforPassword">
    ...
    <div>
      <p style="font-size: 12px;">We’ll call or text you to confirm your number. Standard message and data rates apply. Privacy Policy</p>
    </div>
    <div><button class="btn" @click="submitResult"> Continue </button></div>
  </div>
</div>
</template>
<script setup>
