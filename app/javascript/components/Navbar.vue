...
<div class="container">
  <div class="navbar-block">
    ...
    <div v-if="storeAuth.searchClose" class="btn-block" @click="searchOpen" >
      <div class="search-for-button"></div>
        ...
        <div>
          <div class="block-for-input">
            <div class="input-content">
              <label>Name</label>
              <input type="text" placeholder="Property name" class="input"/>
            </div>
            <div class="btn-block">
              <div class="search-for-button"></div>
              <button class="btn">Search</button> 
    ...
    <transition name="fade">
      <div v-if="storeAuth.loginOpen" class="open-action">
        <p @click="showLogin" class="pointer">Log in</p>
  ...
  <div :class="{darkBlock: ( storeAuth.dialogLogin || storeAuth.dialogSignUp)}">
    <transition name="fade">
      <DialogLogin v-if="storeAuth.dialogLogin" class="test"/>
    </transition>
    <transition name="fade">
