<template>
  <div>
    <div class="section">
      <div class="block-inf">
        <h2>Hidden Haven - 5 Bed Villa with pool & Sea Views</h2>
        <div class="place-description">
          <div class="plDec-one">
            <div>
              ...
              <p style="padding:0 20px">Superhost</p>
              <p style="padding-right:8px">·</p>
              <h4 style="text-decoration:underline">Cape Town, Western Cape, South Africa</h4> 
            </div>
          </div>
          <div class="plDec-two">
            <div>
      ...
      <div class="block-picture">
        <div class="cont-fot-pict-1"><div class="img-1"></div></div>
        <div class="cont-fot-pict-2">
          <div class="img-2"></div>
          <div class="img-3"></div>
          <div class="img-4"></div>
          <div class="img-5"></div>
...
.place-description , .plDec-one , .plDec-two{
  display: flex;
  flex-direction: row;
